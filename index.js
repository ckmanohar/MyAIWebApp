document.addEventListener('DOMContentLoaded', function() {
  fetch('https://sex7ipwouhts2ltvzwjellws2y0kjepm.lambda-url.us-east-1.on.aws') //Fetch LAMBDA FUNCTION URL - make sure to not add a trailing slash
  ...
  function generateAiDescription(imageId) {
    const aiDescriptionEndpoint = 'https://6y2sk75obiwlszilykjep3ypn40gggaj.lambda-url.us-east-1.on.aws'; // GENERATE AI LAMBDA FUNCTION URL - and 
